...
Real VMacQDGraphicContext::GetTextWidth(const VString& inString) const
{
	StUseContext_NoRetain	context(this);
...
void VMacQDGraphicContext::DrawText(const VString& inString, TextLayoutMode inOptions)
{
...
void VMacQDGraphicContext::DrawText (const VString& inString, const VPoint& inPos, TextLayoutMode /*inLayoutMode*/)
{
	VStringConvertBuffer macStr( inString, VTC_MacOSAnsi);
