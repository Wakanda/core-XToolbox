...
public:
	...
	virtual	bool				GetDesiredAntiAliasing() const { return fIsHighQualityAntialiased ; }
			...
			*/
			void				CEAdjustPointInTransformedSpace( VPoint& ioPos, bool inFillOnly = false, VPoint *outPosTransformed = NULL);
	...
	static	void				ApplyStandardPattern (PatternStyle inPatternStyle, ContextRef inContext);
...
public:
			StEnableShapeCrispEdges(VGraphicContext *inGC)
			{
				...
				inGC->Retain();
				fGC = inGC;
				fShapeCrispEdgesEnabled = fGC->EnableShapeCrispEdges( true);
