...
public:
	...
	*/
	...
	virtual void	SetTransparency (GReal inAlpha);	// Global Alpha - added to existing line or fill alpha
...
protected:
	...
	*/
	VGraphicContext *_BeginUsingGdiplusContext( const VRect* inBounds = NULL) const;

	/** end using derived Gdiplus context over render target */
	void _EndUsingGdiplusContext() const; 
...
public:
	 ...
	 */
	virtual bool	DrawLayerOffScreen(const VRect& inBounds, VImageOffScreenRef inBackBuffer);
	...
	*/
	...
	virtual GReal	GetTextWidth (const VString& inString) const;
	...
	virtual void	DrawText (const VString& inString, TextLayoutMode inMode = TLM_NORMAL);
...
protected:
	...
	*/
	...
	mutable HDC					fChildHDC;
	mutable VGraphicContext		*fChildGC;
	mutable bool				fChildGCNeedRestoreClip;
