...
#endif				
				fStandardInitialized = inMetrics.fStandardInitialized;
				if (fStandardInitialized)
				{
					fStandardMetrics.fAscent			= inMetrics.fStandardMetrics.fAscent;
					fStandardMetrics.fDescent			= inMetrics.fStandardMetrics.fDescent;
					fStandardMetrics.fInternalLeading	= inMetrics.fStandardMetrics.fInternalLeading;
					fStandardMetrics.fExternalLeading	= inMetrics.fStandardMetrics.fExternalLeading;
				}
			}
...
#endif
			bool				IsStandardInitialized() const { return fStandardInitialized; }
			void				SetStandard( const GReal inAscent, const GReal inDescent, const GReal inInternalLeading, const GReal inExternalLeading)
			{	
				fStandardMetrics.fAscent			= inAscent;
				fStandardMetrics.fDescent			= inDescent;
				fStandardMetrics.fInternalLeading	= inInternalLeading;
				fStandardMetrics.fExternalLeading	= inExternalLeading;
				fStandardInitialized = true;
			}
			void				GetStandard( GReal &outAscent, GReal &outDescent, GReal &outInternalLeading, GReal &outExternalLeading) const
			{
				outAscent						= fStandardMetrics.fAscent;
				outDescent						= fStandardMetrics.fDescent;
				outInternalLeading				= fStandardMetrics.fInternalLeading;
				outExternalLeading				= fStandardMetrics.fExternalLeading;
			}

protected:
#if VERSIONWIN
			bool				fLegacyInitialized;
			sBaseFontMetrics	fLegacyMetrics;
#endif
			bool				fStandardInitialized;
			sBaseFontMetrics	fStandardMetrics;
};
