...
protected:
			...
			VArrayOf<VPattern*>	fFillPatternStack;
			
			VPattern*			fLinePattern;
			VArrayOf<VPattern*>	fLinePatternStack;
			
			GReal				fLineWidth;
			VArrayOf<GReal>		fLineWidthStack;

			bool				fUseLineDash;
			VArrayOf<bool>		fLineDashStack;
	...
	mutable TextLayoutMode		fTextLayoutMode;
			...
			VArrayOf<Boolean>*	fAxisInvertedStack;	// Additional context store/restore data
...
public:
			...
			VMacQuartzBitmapContext(const VRect& inBounds, Boolean inReversed);
