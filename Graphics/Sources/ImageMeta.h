...
namespace ImageMeta 
{
	static VValueBag sMapIPTCObjectCycleFromString;
	static std::map<sLONG,VString> sMapIPTCObjectCycleFromLong;

	static VValueBag sMapIPTCImageTypeFromString;
	static std::map<sLONG,VString> sMapIPTCImageTypeFromLong;

	static VValueBag sMapIPTCImageOrientationFromString;
	static std::map<sLONG,VString> sMapIPTCImageOrientationFromLong;

	static VValueBag sMapGPSStatusFromString;
	static std::map<sLONG,VString> sMapGPSStatusFromLong;

	static VValueBag sMapGPSDistanceRefFromString;
	static std::map<sLONG,VString> sMapGPSDistanceRefFromLong;

	static VValueBag sMapGPSNorthTypeFromString;
	static std::map<sLONG,VString> sMapGPSNorthTypeFromLong;
