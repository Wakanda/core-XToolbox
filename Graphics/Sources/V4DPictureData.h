...
public:
	...
	static void InitStatic(VPictureQDBridgeBase* inBridge,VMacPictureAllocatorBase *inAlloc)
	{
		sQDBridge=inBridge;
	...
	*/
	...
	static void SetMacAllocator(VMacPictureAllocatorBase *inAlloc)
	{
		sMacAllocator=inAlloc;
	}
	static VMacPictureAllocatorBase* GetMacAllocator()
	{
...
// pour obtenir une copie d'un type x, qq soit le type de la source il faut utiliser Create... c'est a lutilisateur de lobject reournŽ de le disposŽ
	...
	virtual Gdiplus::Bitmap*	CreateGDIPlus_Bitmap(VPictureDrawSettings* inSet=NULL,VRect* inSub=0)const;
