...
void VPictureQDBridgeBase::DrawInCGContext(const VPictureData &inCaller,xMacPictureHandle inPict,ContextRef inContextRef,const VRect& inBounds,VPictureDrawSettings* inSet)
{
 ...
 void VPictureQDBridgeBase::DrawInCGContext(const VPictureData &inCaller,QDPictRef inPict,ContextRef inContextRef,const VRect& inBounds,VPictureDrawSettings* inSet)
{
	inCaller.xDraw(inPict,inContextRef,inBounds,inSet);
}
#endif
...
VPictureData*	VPictureData::CreateSubPicture(VRect& inSubRect,VPictureDrawSettings* inSet)const
{
	...
	#if VERSIONWIN
	Gdiplus::Bitmap* bm=CreateGDIPlus_Bitmap(inSet,&inSubRect);
	if(bm)
	{
...
Gdiplus::Bitmap* VPictureData::CreateGDIPlus_Bitmap(VPictureDrawSettings* inSet,VRect* inSub) const
{
...
void VPictureData::xDraw(QDPictRef inPict,PortRef inPortRef,const VRect& inBounds,VPictureDrawSettings* inSet)const
{
	if(inPict && sQDBridge)
	{
