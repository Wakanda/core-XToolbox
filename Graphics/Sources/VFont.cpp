...
#endif
			if (itMetrics->second.IsStandardInitialized())
			{
				itMetrics->second.GetStandard( outAscent, outDescent, outInternalLeading, outExternalLeading);
				return;
			}
...
#endif
			itMetrics->second.SetStandard( outAscent, outDescent, outInternalLeading, outExternalLeading);
...
#endif
		thisCachedmetrics.SetStandard( outAscent, outDescent, outInternalLeading, outExternalLeading);
