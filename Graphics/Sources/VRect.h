...
class XTOOLBOX_API VRect : public VObject, public IStreamable
{
 public:
	...
	// Accessors
	void	SetPosBy (GReal inHoriz, GReal inVert) { fX += inHoriz; fY += inVert; };
	void	SetSizeBy (GReal inHoriz, GReal inVert) { fWidth += inHoriz; fHeight += inVert; };
	...
	void	SetPosTo (const GReal inX,const GReal inY){fX = inX; fY = inY;};
	void	SetSizeTo (GReal inWidth, GReal inHeight);
	void	SetCoordsTo (GReal inX, GReal inY, GReal inWidth, GReal inHeight) { fX = inX; fY = inY; fWidth = inWidth; fHeight = inHeight; };
	void	SetCoordsBy (GReal inX, GReal inY, GReal inWidth, GReal inHeight) { fX += inX; fY += inY; fWidth += inWidth; fHeight += inHeight; };
	...
	void	SetX (GReal inX) { fX = inX; }
	void	SetY (GReal inY) { fY = inY; }
	
	void	SetWidth (GReal inWidth) { fWidth = inWidth; }
	void	SetHeight (GReal inHeight) { fHeight = inHeight; }
