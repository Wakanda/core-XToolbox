...
VGraphicContext* VMapOfComputingGC::Create(const GraphicContextType inType)
{
	...
	VGraphicContext *gc = VGraphicContext::CreateBitmapGraphicContext( 1, 1, 1.0f, true, NULL, true, (GraphicContextType)type);  
	if (gc && addToMap)
...
void VGraphicContext::ApplyStandardPattern(PatternStyle inPatternStyle, ContextRef inContext)
{
...
#if VERSIONMAC
//	VMacQuartzGraphicContext::ApplyStandardPattern(inPatternStyle, inContext);
#else
//	VWinGDIGraphicContext::ApplyStandardPattern(inPatternStyle, inContext);
//	VWinGDIPlusGraphicContext::ApplyStandardPattern(inPatternStyle, inContext);
#endif
}
