...
*/
virtual void SerializeDocument( const VDocText *inDoc, VString& outDocText, const VDocText *inDocDefaultStyle = NULL, bool inSerializeDefaultStyle = false);
...
bool _SerializeAttributeClass( const VDocNode *inDocNode, VString& outText);
...
void _OpenTagParagraph(VString& ioText, sLONG inIndent = 0);
void _CloseTagParagraph(VString& ioText, bool inAfterChildren = true, sLONG inIndent = 0);
