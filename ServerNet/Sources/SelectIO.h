...
class XTOOLBOX_API CTCPSelectIOHandler
{
	...
	virtual VError	AddSocketForReading ( Socket inRawSocket ) = 0;
...
class XTOOLBOX_API VTCPSelectReadAction : public VTCPSelectAction
{
	public :
				...
				VTCPSelectReadAction (Socket inSocket, char* inBuffer, uLONG* inBufferSize);
...
class XTOOLBOX_API VTCPSelectIOHandler : public CTCPSelectIOHandler, public VTask
{
	public :
		...
		virtual VError	AddSocketForReading ( Socket nRawSocket );
