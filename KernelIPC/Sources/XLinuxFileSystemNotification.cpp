...
#else
//A few definitions needed to compile on XCode
	int	inotify_init()			{ return -1; }
	int inotify_add_watch(...)	{ return -1; }
	int inotify_rm_watch(...)   { return -1; }
	const int IN_CREATE=0, IN_DELETE=0, IN_MODIFY=0, IN_MOVED_FROM=0, IN_MOVED_TO=0;
