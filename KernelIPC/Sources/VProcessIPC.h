...
public:
	...
	static	VProcessIPC*			Get()							{ return sInstance; }
			...
			//@{
			//! Set the command line arguments (UTF-8, Unixes), provided by main()
			void SetCommandLineArguments(sLONG inArgc, const char** inArgv);
			//! Set the command line arguments (UTF-16, Windows), provided by main()
			void SetCommandLineArguments(sLONG inArgc, const wchar_t** inArgv);
...
private:
			...
			//! Command line arguments, provided by main()
			std::vector<VString>  fCommandLineArguments;
