...
VError XLinuxFileDesc::GetData(void *outData, VSize &ioCount, sLONG8 inOffset, bool inFromStart) const
{
	...
	VError verr=SetPos(inOffset, inFromStart);
...
{
	return SetPos(inOffset, (inFromStart==true ? SET : CUR));
}
