...
class unordered_map_VString : public std::tr1::unordered_map<XBOX::VString,Value,XBOX::hash_VString::hash, XBOX::hash_VString::equal_to>
{
public:
	unordered_map_VString( size_t inBuckets = 10)
		: std::tr1::unordered_map<VString,Value,hash_VString::hash, hash_VString::equal_to>( inBuckets, hash_VString::hash(), hash_VString::equal_to()) {}

	template <typename InputIterator>
	unordered_map_VString( InputIterator begin, InputIterator end) : std::tr1::unordered_map<VString,Value,hash_VString::hash, hash_VString::equal_to>( begin, end) {}
};
