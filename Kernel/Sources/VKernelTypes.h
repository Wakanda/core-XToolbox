...
#define kDOC_VERSION_SPAN4D			1		//v13 span format (4D SPAN text): all span CSS styles are inherited & on Windows point font-size value is equal to point font size*72/screen dpi

#define kDOC_VERSION_XHTML4D		2		//V15 XHMTL 4D document format: full support for new XHTML4D document format (should be fully implemented only for v15+) - W3C CSS inheriting rules compliancy for background-color & text-decoration
