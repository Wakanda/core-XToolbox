...
// Flag to enable C++ mangling for componentlib entry points
	...
	#define	USE_UNMANGLED_EXPORTS	VERSION_MACHO
#endif
...
//Isolate ongoing dev on crypto verifier API

#if VERSIONMAC || VERSIONWIN
	#define WITH_CRYPTO_VERIFIER_API 1
#endif

#ifndef WITH_CRYPTO_VERIFIER_API
	#define WITH_CRYPTO_VERIFIER_API 0
#endif
