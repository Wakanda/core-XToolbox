...
/*
 *      $Id: mapmfmul.c,v 1.24 2001/02/11 22:34:47 mike Exp $
 *
 ...
 *      524,288 digit numbers yielding a 1,048,675 digit result.
 */
...
/****************************************************************************/
void   	M_fmul_split(x1, x0, xin, nbytes)
UCHAR   *x1, *x0, *xin;
int	nbytes;
{
 ...
 */
void	M_fmul_div_conq(rr, aa, bb, sz)
UCHAR	*rr, *aa, *bb;
int	sz;
{
