...
/*
 *      $Id: mapm_rnd.c,v 1.7 2001/03/20 17:19:45 mike Exp $
 *
 ...
 */
void	m_apm_get_random(mrnd)
M_APM   mrnd;
{
static  int  firsttimer = TRUE;

if (firsttimer)           /* use the system time as the initial seed value */
  {
   firsttimer = FALSE;
...
/****************************************************************************/
/*
 *  for DOS systems : use 'ftime' 
 */
void	M_get_rnd_seed(mm)
M_APM   mm;
{
int              millisec;
time_t 		 timestamp;
