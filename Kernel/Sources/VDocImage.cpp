...
const VString& VDocImage::GetAltText() const { return IDocProperty::GetPropertyRef<VString>( static_cast<const VDocNode *>(this), kDOC_PROP_IMG_ALT_TEXT); }

/** set image alternate text */
void VDocImage::SetAltText( const VString& inText) { IDocProperty::SetPropertyPerRef<VString>( static_cast<VDocNode *>(this), kDOC_PROP_IMG_ALT_TEXT, inText); }
