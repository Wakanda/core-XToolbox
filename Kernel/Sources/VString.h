...
public:
	...
	*/
			void				RemoveWhiteSpaces( bool inLeadings = true, bool inTrailings = true, VIndex* outLeadingsRemoved = NULL, VIndex* outTrailingsRemoved = NULL, VIntlMgr *inIntlMgr = NULL);
...
{
public:
			VOsTypeString()								{ _AdjustPrivateBufferSize( 4);}
