...
public:
	...
	*/
	...
	/*!
		@function	VURL
		@abstract	Creates a Relative VURL from VURL and a VString.
		@param		inBaseURL the base url of the URL
		@param		inRelativPath the relative path string ( au format eURL_POSIX_STYLE )
		@param		inStyle the style of the incomming string
	*/
	explicit	VURL( const VURL& inBaseURL, const VString& inRelativPath, bool inEncodedString);
	...
	*/
	...
	/*!
		...
		@abstract	Rebuilds a Relative VURL from a VURL and a VString.
		@param		inBaseURL the base folder of the URL
		@param		inRelativPath the relative path string
		@param		inStyle the style of the incomming string
	*/
	void	FromRelativePath( const VURL& inBaseURL, const VString& inRelativPath, bool inEncodedString);
	...
	*/
	...
	/*!
		@function	GetBaseURL
		@abstract	returns the base part of the URL if exists, or NULL if absolute URL
	*/
	const VURL*	GetBaseURL() const { return fBaseURL ;}
	void		SetBaseURL(const VURL& inURL);
