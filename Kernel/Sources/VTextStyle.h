...
typedef void (*fnAfterReplace)(void *inUserData, sLONG inStartReplaced, sLONG inEndReplaced);
	...
	*/
	static bool ReplaceAndOwnSpanRef( VString& ioText, VTreeTextStyle*& ioStyles, VDocSpanTextRef* inSpanRef, sLONG inStart = 0, sLONG inEnd = -1, bool inAutoAdjustRangeWithSpanRef = true, bool inSkipCheckRange = false, bool inNoUpdateRef = true, void *inUserData = NULL, fnBeforeReplace inBeforeReplace = NULL, fnAfterReplace inAfterReplace = NULL, VDBLanguageContext *inLC = NULL);
...
*/
virtual void SerializeDocument( const VDocText *inDoc, VString& outDocText, const VDocClassStyleManager *inDocDefaultStyleMgr = NULL, bool inSerializeDefaultStyle = false) = 0;
};
