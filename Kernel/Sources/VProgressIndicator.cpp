...
VError VProgressIndicatorInfo::GetJSONObject(VJSONObject& outObject)const
{
	...
	VJSONValue duration(XBOX::JSON_number);
	VTime t;
	VDuration d;
	GetDuration(d);
	GetStartTime(t);
...
:fUUID(true),fCollectedInfoStamp(0),fNeedCollectInfoStamp(0)
#if defined(VERSIONDEBUG)
	,fDbgOwnerTaskId(0)
#endif //VERSIONDEBUG
...
:fUUID(inUUID),fCollectedInfoStamp(0),fNeedCollectInfoStamp(0)
#if defined(VERSIONDEBUG)
	,fDbgOwnerTaskId(0)
#endif //VERSIONDEBUG
