...
void VString::RemoveWhiteSpaces( bool inLeadings, bool inTrailings, VIndex* outLeadingsRemoved, VIndex* outTrailingsRemoved )
{
	if ( inLeadings )
	{
		VIndex i = 0;
...
{
	if (!testAssert(inFirst > 0 && inFirst <= fLength && inNbChars >= 0))
		outResult.Clear();
	else
	{
