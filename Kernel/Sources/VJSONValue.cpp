...
VError VJSONValue::ParseFromString(const VString& inString)
{
	return VJSONImporter::ParseString(inString, *this);
}

VError VJSONValue::LoadFromFile(const VFile* fromFile)
{
	return VJSONImporter::ParseFile(fromFile, *this);
}
...
VValueSingle* VJSONValue::CreateVValue() const
{
