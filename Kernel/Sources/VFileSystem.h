...
public:
			...
			bool					ParsePathWithFileSystem( const VString& inPath, VFile **outFile, VFolder **outFolder);

			bool					ParsePathWithFileSystem( const VString& inPath, VFileSystem* &outFS, VFilePath& outPath);
