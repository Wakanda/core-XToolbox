...
class XWinStringCompare
{
public:
			XWinStringCompare( DialectCode inDialect, VIntlMgr *inIntlMgr);
			XWinStringCompare( const XWinStringCompare& inOther);
	virtual	~XWinStringCompare();
	...
	LCID			GetLocale() const	{ return fLocale;}
	
protected:
	LCID			fLocale;
};
typedef XWinStringCompare XStringCompareImpl;
