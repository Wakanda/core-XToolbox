...
class JSDEBUGGER_API VJSDebugger : public IJSDebugger
{
	public:
		...
		XBOX::VError SetBreakPoint ( XBOX::VString const & inRelativeFilePath, XBOX::VIndex inLineNumber );
		XBOX::VError SetBreakPoints ( XBOX::VString const & inRelativeFilePath, std::vector< sLONG >& inLineNumbers, std::vector<bool>& inDisabled );
		...
		XBOX::VError RemoveBreakPoint ( XBOX::VString const & inRelativeFilePath, XBOX::VIndex inLineNumber );
		XBOX::VError RemoveBreakPoints ( XBOX::VString const & inRelativeFilePath, std::vector< sLONG >& inLineNumbers, std::vector<bool>& inDisabled );
