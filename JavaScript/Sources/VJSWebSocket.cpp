...
VJSWebSocketObject::~VJSWebSocketObject ()
{
	...
	// WAK0087140: Prevent destructor to be called along read callback.
...
XBOX::VJSObject	VJSWebSocketClass::MakeConstructor (const XBOX::VJSContext &inContext)
{
	...
	XBOX::VJSObject	wsConstructor(inContext);
	wsConstructor.MakeConstructor(Class(), js_constructor<_Construct>);
...
XBOX::VJSObject	VJSWebSocketSyncClass::MakeConstructor (const XBOX::VJSContext &inContext)
{
	...
	XBOX::VJSObject	wsSyncConstructor(inContext);
	wsSyncConstructor.MakeConstructor(Class(), js_constructor<_Construct>);
...
XBOX::VJSObject VJSWebSocketServerClass::MakeConstructor (const XBOX::VJSContext &inContext)
{
	...
	XBOX::VJSObject	wsServerConstructor(inContext);
	wsServerConstructor.MakeConstructor(Class(), js_constructor<_Construct>);
