...
public:
	...
	return NULL;
		...
		*/
			VJSValue			Parse( const XBOX::VString& inJSON, XBOX::VJSException *outException = NULL);
...
private:
	...
	static	JS4D::ObjectRef		_GetJSON( JS4D::ContextRef inContext, JS4D::ExceptionRef *outException);
			...
			void				_Stringify( const XBOX::VJSValue& inValue, JS4D::ValueRef inReplacer, JS4D::ValueRef inSpace, XBOX::VString& outJSON, JS4D::ExceptionRef *outException);
