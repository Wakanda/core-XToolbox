...
public:
	...
	return NULL;
		...
		*/
			...
			VJSValue			Parse( const XBOX::VString& inJSON, XBOX::VJSException& ioException) {
				return Parse(inJSON,ioException.GetPtr());
			}
		/*
		...
		*/
			...
			void				Stringify( const VJSValue& inValue, XBOX::VString& outJSON, XBOX::VJSException& outException) {
				Stringify(inValue,outJSON,outException.GetPtr());
			}
