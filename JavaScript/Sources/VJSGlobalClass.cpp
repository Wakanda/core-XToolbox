...
DebugMsg("VJSGlobalClass::Initialize called\n");
	...
	{
		VJSProcess::Class();
		globalObject.SetProperty( CVSTR( "process"), VJSProcess::CreateInstance(context, eventEmitter), JS4D::PropertyAttributeDontDelete | JS4D::PropertyAttributeReadOnly);
	}
...
// WebSocketServer object is not active for WAK8.
