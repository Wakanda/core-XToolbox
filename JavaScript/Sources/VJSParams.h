...
public:
	...
	/*typedef void (*fn_construct)( VJSParms_callAsConstructor&);
	template<fn_construct fn>
	static	void __cdecl Callback(VJSParms_callAsConstructor* inParms);*/
...
#if USE_V8_ENGINE
class XTOOLBOX_API VJSParms_withPropertyCallbackReturnValue : public virtual VJSParms_withException
{
public:

			VJSParms_withPropertyCallbackReturnValue( const v8::PropertyCallbackInfo<v8::Value>* info );
...
#if USE_V8_ENGINE
: public VJSParms_withPropertyCallbackReturnValue
#else
...
inline	void				VJSParms_construct::ReturnConstructedObject( typename JSCLASS::PrivateDataType *inPrivateData)
{
	if (inPrivateData != NULL)
	{
		...
		for(;;)
		{
			XBOX::DebugMsg("%s  NOT IMPL\n","VJSParms_construct::ReturnConstructedObject2" );
		}
...
#if USE_V8_ENGINE
inline	void					VJSParms_callAsConstructor::ReturnUndefined()
{ 
	xbox_assert(false);/*fConstructedObject.SetUndefined();*/ 
}
...
{ 
	return 0; 
} //GH JS4D::StringToLong( fPropertyName, outValue);}
