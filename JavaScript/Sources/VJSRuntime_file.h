...
public:
	...
	static void				do_Folder (VJSParms_callStaticFunction& ioParms);	// Used by Studio ?
...
private:
	...
	static void				_CallAsConstructor (VJSParms_callAsConstructor &ioParms);
...
public:
	...
	static void				do_File (VJSParms_callStaticFunction &ioParms);		// Used by studio code.
...
public:
	...
	static	VFile*		ResolveFileParam( const VJSContext& inContext, const VString& inJSPathParam);
