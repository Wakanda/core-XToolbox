...
public:
	...
	enum {
		...
		eTYPE_WEB_SOCKET,		// Events for WebSocket API.
...
public:
	...
	static VJSSystemWorkerEvent	*Create (VJSSystemWorker *inSystemWorker, sLONG inType, XBOX::JS4D::ObjectRef inObjectRef, uBYTE *inData, sLONG inSize);
	void						Process (XBOX::VJSContext inContext, VJSWorker *inWorker);
	void						Discard ();
...
private:
	...
	XBOX::JS4D::ObjectRef		fObjectRef;		// Object containing the callback.
...
private:
	...
	sLONG					fSubType;
	XBOX::JS4D::ObjectRef	fSuccessCallback;
	XBOX::JS4D::ObjectRef	fErrorCallback;
...
public:
	...
	static VJSWebSocketEvent	*CreateOpenEvent (XBOX::JS4D::ObjectRef inObjectRef, const XBOX::VString &inProtocol, const XBOX::VString &inExtensions);
	static VJSWebSocketEvent	*CreateMessageEvent (XBOX::JS4D::ObjectRef inObjectRef, bool inIsText, uBYTE *inData, VSize inSize);
	static VJSWebSocketEvent	*CreateErrorEvent (XBOX::JS4D::ObjectRef inObjectRef);
	static VJSWebSocketEvent	*CreateCloseEvent (XBOX::JS4D::ObjectRef inObjectRef, bool inWasClean, sLONG inCode, const XBOX::VString &inReason);
...
private:
	...
	sLONG						fSubType;			// Type of event.
	XBOX::JS4D::ObjectRef		fObjectRef;			// WebSocket object.
