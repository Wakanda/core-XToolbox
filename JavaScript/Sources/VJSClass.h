...
#if USE_V8_ENGINE
static void __cdecl js_constructor(VJSParms_callAsConstructor* parms)
...
{
public:
	static	bool CallAsConstructor(JS4D::ClassRef inClassRef,VJSParms_callAsConstructor& parms, fn_callAsConstructor fn );
...
#if  USE_V8_ENGINE
	static JS4D::V8ObjectGetPropertyCallback*  js_getProperty()
	{
		return VJSClass__GetPropertyGetterCallback( (GetPropertyFn)fn );
	}
#else
...
#if  USE_V8_ENGINE
	static JS4D::V8ObjectSetPropertyCallback*  js_setProperty()
	{
		return VJSClass__GetPropertySetterCallback( (SetPropertyFn)fn );
	}
#else
...
#if USE_V8_ENGINE
	static void __cdecl js_callAsConstructor(VJSParms_callAsConstructor* parms)
	{
xbox::DebugMsg("js_callAsConstructor called !!!\n");
	    JS4D::ClassRef classRef = Class();
		VJSClassImpl::CallAsConstructor(classRef,*parms,fn);
        {
        }
	}
...
static JS4D::ObjectRef __cdecl js_callAsConstructor( JS4D::ContextRef inContext, JS4D::ObjectRef inConstructor, size_t inArgumentCount, const JS4D::ValueRef inArguments[], JS4D::ExceptionRef* outException)
	...
	{
xbox::DebugMsg("VJSClass::CreateInstance2 called !!!\n");
