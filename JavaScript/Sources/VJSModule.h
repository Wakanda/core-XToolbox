...
public:
	static void						SetRequireFunctionURL(const XBOX::VString& inURL);

									VJSModuleState (XBOX::VJSContext inContext);
...
private:
	...
	// Retrieve the URL string of requireFunction.js. 

	static void						_GetRequireFunctionURL (XBOX::VString *outURLString);	

	static XBOX::VString			sRequireFunctionURL;
