...
public:
	...
	//typedef v8::Persistent< v8::Value >*					ValueRef;
	typedef	v8::Value*										ValueRef;
	//typedef	void*	 										ValueRef;
	//typedef v8::Persistent< v8::Value >*					ObjectRef;
	typedef	v8::Value*										ObjectRef;
	//typedef	void*	 										ObjectRef;
	//typedef v8::Persistent< v8::Value >*					ExceptionRef;
	typedef	v8::Value*										ExceptionRef;
	//typedef	void*	 										ExceptionRef;
#else
...
#if USE_V8_ENGINE
	static	void					VFileToObject( ContextRef inContext, XBOX::VFile *inFile, v8::Persistent< v8::Value >* ioValue, ExceptionRef *outException);
	static	ObjectRef				VFolderToObject( ContextRef inContext, XBOX::VFolder *inFolder, ExceptionRef *outException);
	static	void					VFilePathToObjectAsFileOrFolder( ContextRef inContext, const XBOX::VFilePath& inPath, v8::Persistent< v8::Value >* ioValue, ExceptionRef *outException);
#else
...
#if USE_V8_ENGINE
	static	void					VStringToValue( ContextRef inContext, const XBOX::VString& inString, v8::Persistent< v8::Value >* ioValue);
#else
...
#if USE_V8_ENGINE
	static	void					BoolToValue( ContextRef inContext, bool inValue, v8::Persistent< v8::Value >* ioPersVal);
#else
	static	ValueRef				BoolToValue( ContextRef inContext, bool inValue);
#endif
	
#if USE_V8_ENGINE
	static	void					DoubleToValue( ContextRef inContext, double inValue, v8::Persistent< v8::Value >* ioPersVal);
#else
...
template<class Type>
#if USE_V8_ENGINE
	static	void					NumberToValue( ContextRef inContext, const Type& inValue, v8::Persistent< v8::Value >* ioPersVal)
				{
...
#if USE_V8_ENGINE
	static	void					VTimeToObject( ContextRef inContext, const XBOX::VTime& inDate, v8::Persistent< v8::Value >* ioPersVal, ExceptionRef *outException);
#else
...
#if USE_V8_ENGINE
	static	bool					DateObjectToVTime( ContextRef inContext, const v8::Handle<v8::Value>&, XBOX::VTime& outTime, ExceptionRef *outException, bool simpleDate);
#else
...
#if USE_V8_ENGINE
	static	void					VDurationToValue( ContextRef inContext, const XBOX::VDuration& inDuration,v8::Persistent< v8::Value >* ioPersVal);
#else
...
#if USE_V8_ENGINE
	static	void					MakeUndefined( ContextRef inContext, v8::Persistent< v8::Value >* ioPersVal);
	static	void					MakeNull( ContextRef inContext, v8::Persistent< v8::Value >* ioPersVal);
#else
