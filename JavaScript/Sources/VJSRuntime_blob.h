...
public:
	...
	static XBOX::VJSObject	NewInstance (XBOX::VJSContext inContext, VSize inLength, void *inData, const XBOX::VString &inContentType);

	static	void			Initialize( const XBOX::VJSParms_initialize& inParms, VJSBlobValue* inBlob);
	static	void			Finalize( const XBOX::VJSParms_finalize& inParms, VJSBlobValue* inBlob);
	static	void			GetDefinition( ClassDefinition& outDefinition);
	static	void			Construct( VJSParms_construct &ioParms);

	static	void			do_Slice( XBOX::VJSParms_callStaticFunction& ioParms, VJSBlobValue* inBlob);
	static	void			do_ToBuffer( XBOX::VJSParms_callStaticFunction& ioParms, VJSBlobValue* inBlob);

	static	void			do_ToString( XBOX::VJSParms_callStaticFunction& ioParms, VJSBlobValue* inBlob);
	static	void			do_WriteString( XBOX::VJSParms_callStaticFunction& ioParms, VJSBlobValue* inBlob);

	static	void			do_GetSize( XBOX::VJSParms_getProperty& ioParms, VJSBlobValue* inBlob);
	static	void			do_GetType( XBOX::VJSParms_getProperty& ioParms, VJSBlobValue* inBlob);
