...
void VJSArrayBufferClass::_Construct (XBOX::VJSParms_callAsConstructor &ioParms)
{
	...
	if ((arrayBuffer = new VJSArrayBufferObject(size)) == NULL) {
		...
		ioParms.ReturnConstructedObject(VJSArrayBufferClass::CreateInstance(ioParms.GetContext(), arrayBuffer));
		arrayBuffer->Release();
...
void VJSTypedArrayObject::AddConstructors (XBOX::VJSContext inContext, XBOX::VJSObject inObject)
{
	...
	constructor.MakeConstructor(VJSInt8ArrayClass::Class(), js_constructor<VJSTypedArrayObject::Construct<VJSInt8ArrayClass, sBYTE> >);
	inObject.SetProperty("Int8Array", constructor, XBOX::JS4D::PropertyAttributeDontDelete | XBOX::JS4D::PropertyAttributeReadOnly);
	constructor.MakeConstructor(VJSUInt8ArrayClass::Class(), js_constructor<VJSTypedArrayObject::Construct<VJSUInt8ArrayClass, uBYTE> >);
	inObject.SetProperty("UInt8Array", constructor, XBOX::JS4D::PropertyAttributeDontDelete | XBOX::JS4D::PropertyAttributeReadOnly);

	constructor.MakeConstructor(VJSInt16ArrayClass::Class(), js_constructor<VJSTypedArrayObject::Construct<VJSInt16ArrayClass, sWORD> >);
	inObject.SetProperty("Int16Array", constructor, XBOX::JS4D::PropertyAttributeDontDelete | XBOX::JS4D::PropertyAttributeReadOnly);
	constructor.MakeConstructor(VJSUInt16ArrayClass::Class(), js_constructor<VJSTypedArrayObject::Construct<VJSUInt16ArrayClass, uWORD> >);
	inObject.SetProperty("UInt16Array", constructor, XBOX::JS4D::PropertyAttributeDontDelete | XBOX::JS4D::PropertyAttributeReadOnly);
	
	constructor.MakeConstructor(VJSInt32ArrayClass::Class(), js_constructor<VJSTypedArrayObject::Construct<VJSInt32ArrayClass, sLONG> >);
	inObject.SetProperty("Int32Array", constructor, XBOX::JS4D::PropertyAttributeDontDelete | XBOX::JS4D::PropertyAttributeReadOnly);
	constructor.MakeConstructor(VJSUInt32ArrayClass::Class(), js_constructor<VJSTypedArrayObject::Construct<VJSUInt32ArrayClass, uLONG> >);
	inObject.SetProperty("UInt32Array", constructor, XBOX::JS4D::PropertyAttributeDontDelete | XBOX::JS4D::PropertyAttributeReadOnly);

	constructor.MakeConstructor(VJSFloat32ArrayClass::Class(), js_constructor<VJSTypedArrayObject::Construct<VJSFloat32ArrayClass, SmallReal> >);
	inObject.SetProperty("Float32Array", constructor, XBOX::JS4D::PropertyAttributeDontDelete | XBOX::JS4D::PropertyAttributeReadOnly);
	constructor.MakeConstructor(VJSFloat64ArrayClass::Class(), js_constructor<VJSTypedArrayObject::Construct<VJSFloat64ArrayClass, Real> >);
	inObject.SetProperty("Float64Array", constructor, XBOX::JS4D::PropertyAttributeDontDelete | XBOX::JS4D::PropertyAttributeReadOnly);
}

template <class CLASS, class TYPE> void VJSTypedArrayObject::Construct (XBOX::VJSParms_callAsConstructor &ioParms)
{
}
