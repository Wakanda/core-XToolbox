...
public:
	...
	static void				do_TextStream (VJSParms_callStaticFunction &ioParms);
...
private:
	...
	static void				_CallAsFunction (VJSParms_callAsFunction &ioParms);									// Create instance using function call syntax.
	static void				_CallAsConstructor (VJSParms_callAsConstructor &ioParms);							// Create instance using constructor (new()) syntax.
